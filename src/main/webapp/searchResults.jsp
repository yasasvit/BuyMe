...
<%
	String listingNameInput = request.getParameter("listingName"); 
	String genderInput = request.getParameter("gender");
	String itemTypeInput = request.getParameter("itemType");
	String brandInput = request.getParameter("brand");
	String sizeInput = request.getParameter("size");
	String sortInput = request.getParameter("sortBy");
