...
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Buy","root", "password"); /* Change to your own pass */
    ...
    ResultSet rs =  st.executeQuery("select i.size, sum(a.earnings) from item i join auction a on i.itemID = a.itemID where a.closed = '1' group by i.size ");
